...
HAL_StatusTypeDef ConfigureCODEC(I2C_HandleTypeDef *hi2c1)
{
	...
	uint8_t config_data[29] = { 0x82, 0x1F, 0x2F, 0x4C, 0x00, 0xA0, 0x20, 0x60, 0x42, 0x00, 0x00, 0x00, 0x00, 0x80, 0x80, 
							    0x80, 0x80, 0x00, 0x00, 0x80, 0x88, 0x00, 0x00, 0x00, 0x00, 0x7F, 0x00, 0x00, 0x3F };
	
	uint8_t status_address 	= 0x20;
	uint8_t status_result	= 0;
	
	status = HAL_I2C_Master_Transmit(hi2c1, 0x94, config_data, 29, HAL_MAX_DELAY);
	if (status != HAL_OK)
	{
